...
def instrument_components_drilldown_bottom(self):
            ...
            for (p09, p10) in exoddos.query_pages:
                ...
                for p01 in utility.last_days_of_the_previous_twelve_months(self):
                    ...
                    query_params = utility.set_query_params(self, userid = self.user.user_id, sessionid = self.user.session_id,
                        p01 = p01, p02 = "F3", p03 = p03, p04 = "S11", p05 = "EUR", p06 = "Y%", p07 = "LS", p08 = "F3A", p09 = p09, p10 = p10, p11 = p11)

                    request_url = "/aquery/idqm.CSECTool20.ISIN.Comp.dw"
                    request_name = f"CSEC > ICDD BOT > {p03}, {p11}, {p09}-{p10:03}, {p01}"
