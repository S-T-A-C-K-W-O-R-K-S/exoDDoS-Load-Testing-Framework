    ...
    with self.client.get("/Admin/Preferences/Collaboration",
        ...
        catch_response=True) as response:
            ...
            if response.status_code == 200:
                ...
                print(utility.timestamp(self) + f"Session ID {self.user.session_id}: User '{self.user.username}' Has Retrieved The Preferences For {retrieved_count} Collaboration(s)")
