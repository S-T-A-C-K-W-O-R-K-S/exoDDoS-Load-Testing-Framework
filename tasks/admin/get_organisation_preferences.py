...
def get_organisation_preferences(self):
    ...
    with self.client.get(f"/Admin/Preferences/Organisation",
        name=f"/Admin/Preferences/Organisation",
        ...
        catch_response=True) as response:
            ...
            if response.status_code == 200:
                ...
                print(utility.timestamp(self) + f"Session ID {self.user.session_id}: User '{self.user.username}' Has Retrieved The Preferences For {retrieved_count} Organisations")
